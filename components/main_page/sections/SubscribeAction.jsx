...
const SubscribeAction = () => {
  return (
    <section className="w-full">
      <div className="mt-10 md:mt-20 py-5 md:py-12 px-5 md:px-10 lg:px-28 max-w-[1320px] mx-auto h-max md:h-[200px] md:space-x-7 flex flex-col md:flex-row flex-shrink-0 subscribe-action rounded-xl">
