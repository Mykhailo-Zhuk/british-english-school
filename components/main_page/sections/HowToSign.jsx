      ...
      <div className="py-10 lg:py-20 h-max w-full max-w-[1320px] mx-auto flex flex-col">
        ...
        <div className="flex flex-col md:flex-row md:space-x-4">
          <div className="w-full lg:1/2 xl:w-2/5 lg:mx-5">
            <div className="min-h-[375px] bg-accent rounded-xl" />
          </div>
          <div className="flex flex-col xl:flex-row xl:flex-wrap w-full lg:1/2 xl:w-3/5 items-center justify-center px-5">
            {context.map((elem) => {
              return (
                <div
                  key={elem.id}
                  className="w-full xl:w-[48%] h-max px-6 pt-6 pb-10 bg-accent rounded-lg xl:odd:mr-6 my-3 flex flex-col space-y-2">
